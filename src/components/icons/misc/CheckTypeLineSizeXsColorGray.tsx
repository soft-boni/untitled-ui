...
export const CheckTypeLineSizeXsColorGray = (props: React.SVGProps<SVGSVGElement>) => (
<svg width="20" height="20" viewBox="0 0 20 20" fill="none"  {...props}>
<g clipPath="url(#clip0_3488_546963)">
<g clipPath="url(#clip1_3488_546963)">
