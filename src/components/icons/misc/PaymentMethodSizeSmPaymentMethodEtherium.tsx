...
export const PaymentMethodSizeSmPaymentMethodEtherium = (props: React.SVGProps<SVGSVGElement>) => (
...
<path d="M4 0.5H30C31.933 0.5 33.5 2.067 33.5 4V20C33.5 21.933 31.933 23.5 30 23.5H4C2.067 23.5 0.5 21.933 0.5 20V4C0.5 2.067 2.067 0.5 4 0.5Z" stroke="currentColor"/>
...
<path fillRule="evenodd" clipRule="evenodd" d="M17.0283 6.35181V14.362L20.5877 12.2578L17.0283 6.35181Z" fill="#C1CCF5"/>
...
<path fillRule="evenodd" clipRule="evenodd" d="M17.0283 15.0359V17.9491L20.59 12.9329L17.0283 15.0359Z" fill="#C1CCF5"/>
</svg>
