...
export const CheckTypeLineSizeXsColorPrimary = (props: React.SVGProps<SVGSVGElement>) => (
<svg width="20" height="20" viewBox="0 0 20 20" fill="none"  {...props}>
<g clipPath="url(#clip0_3488_546961)">
<g clipPath="url(#clip1_3488_546961)">
